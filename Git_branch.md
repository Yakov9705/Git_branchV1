...
Дополнительная [шпаргалка](https://wiki.miem.hse.ru/docs/miem-digital/wiki/markdown "Разметка markdown
...
пример таблиц, их выравнивание стиль аккуратный и не очень\:)
